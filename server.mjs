...
//
// Purpose: permanent 301 from the legacy brand domain (web-dev-studio.com,
// pre-rebrand home of "Web Dev Studio by EUHUB") to the canonical
// build.euhub-ai.com. The redirect must sit in front of EVERYTHING because
...
const CANONICAL_SITE_URL = 'https://build.euhub-ai.com';
const LEGACY_HOSTS = new Set(['web-dev-studio.com', 'www.web-dev-studio.com']);
